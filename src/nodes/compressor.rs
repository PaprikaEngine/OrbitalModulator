...
impl Parameterizable for CompressorNode {
    define_parameters! {
...
mod tests {
    ...
    fn test_compressor_parameters() {
        let mut compressor = CompressorNode::new(44100.0, "test".to_string());
    ...
    #[test]
    fn test_soft_knee() {
        let compressor = CompressorNode::new(44100.0, "test".to_string());
