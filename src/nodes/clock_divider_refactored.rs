...
pub struct ClockDividerNodeRefactored {
    // Node identification
    node_info: NodeInfo,
...
impl ClockDividerNodeRefactored {
    pub fn new(sample_rate: f32, name: String) -> Self {
        ...
        let node_info = NodeInfo {
            id: Uuid::new_v4(),
            name: name.clone(),
            node_type: "clock_divider_refactored".to_string(),
...
impl Parameterizable for ClockDividerNodeRefactored {
...
impl AudioNode for ClockDividerNodeRefactored {
...
mod tests {
    ...
    fn test_clock_divider_parameters() {
        let mut divider = ClockDividerNodeRefactored::new(44100.0, "test".to_string());
