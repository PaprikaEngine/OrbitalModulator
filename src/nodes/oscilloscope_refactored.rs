...
/// - ズーム・時間軸制御
/// - 30FPS更新、グロー効果対応
pub struct OscilloscopeNodeRefactored {
    // Node identification
    node_info: NodeInfo,
...
impl OscilloscopeNodeRefactored {
    pub fn new(sample_rate: f32, name: String) -> Self {
        let node_info = NodeInfo {
            id: Uuid::new_v4(),
            name: name.clone(),
            node_type: "oscilloscope_refactored".to_string(),
...
impl Parameterizable for OscilloscopeNodeRefactored {
    define_parameters! {
...
impl AudioNode for OscilloscopeNodeRefactored {
...
mod tests {
    ...
    fn test_oscilloscope_creation() {
        let scope = OscilloscopeNodeRefactored::new(44100.0, "test_scope".to_string());
    ...
    fn test_oscilloscope_parameters() {
        let mut scope = OscilloscopeNodeRefactored::new(44100.0, "test".to_string());
    ...
    fn test_display_data_access() {
        let scope = OscilloscopeNodeRefactored::new(44100.0, "test".to_string());
