...
pub struct MultipleNodeRefactored {
    // Node identification
    node_info: NodeInfo,
...
impl MultipleNodeRefactored {
    pub fn new(sample_rate: f32, name: String, channel_count: u8) -> Self {
        ...
        let node_info = NodeInfo {
            id: Uuid::new_v4(),
            name: name.clone(),
            node_type: "multiple_refactored".to_string(),
...
impl Parameterizable for MultipleNodeRefactored {
...
impl AudioNode for MultipleNodeRefactored {
...
mod tests {
    ...
    fn test_multiple_parameters() {
        let mut mult = MultipleNodeRefactored::new(44100.0, "test".to_string(), 4);
    ...
    fn test_individual_gains() {
        let mut mult = MultipleNodeRefactored::new(44100.0, "test".to_string(), 3);
    ...
    fn test_buffered_mode() {
        let mut mult = MultipleNodeRefactored::new(44100.0, "test".to_string(), 2);
