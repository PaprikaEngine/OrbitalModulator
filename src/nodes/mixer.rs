...
impl Parameterizable for MixerNode {
...
mod tests {
    ...
    fn test_mixer_creation() {
        let mixer = MixerNode::new(44100.0, "test_mixer".to_string());
    ...
    fn test_mixer_parameters() {
        let mut mixer = MixerNode::new(44100.0, "test".to_string());
    ...
    fn test_pan_calculation() {
        let mixer = MixerNode::new(44100.0, "test".to_string());
