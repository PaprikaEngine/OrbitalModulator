...
impl Parameterizable for NoiseNode {
    define_parameters! {
...
mod tests {
    ...
    fn test_noise_parameters() {
        let mut noise = NoiseNode::new(44100.0, "test".to_string());
    ...
    fn test_deterministic_generation() {
        let mut noise1 = NoiseNode::new(44100.0, "test1".to_string());
        let mut noise2 = NoiseNode::new(44100.0, "test2".to_string());
