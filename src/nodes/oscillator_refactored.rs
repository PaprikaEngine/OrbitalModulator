...
pub struct OscillatorNodeRefactored {
    // Node identification
    node_info: NodeInfo,
...
impl OscillatorNodeRefactored {
    pub fn new(sample_rate: f32, name: String) -> Self {
        let node_info = NodeInfo {
            id: Uuid::new_v4(),
            name: name.clone(),
            node_type: "oscillator_refactored".to_string(),
...
impl Parameterizable for OscillatorNodeRefactored {
    define_parameters! {
...
impl AudioNode for OscillatorNodeRefactored {
...
mod tests {
    ...
    fn test_oscillator_parameters() {
        let mut osc = OscillatorNodeRefactored::new(44100.0, "test".to_string());
    ...
    fn test_waveform_generation() {
        let osc = OscillatorNodeRefactored::new(44100.0, "test".to_string());
